...
export default function Quiz1FABLPage() {
  return (
        ...
        <div className="flex gap-8">
          ...
          <div className="flex-1">
            ...
            <h2 className="text-2xl font-bold text-gray-900 mb-8">
              Your final grade for this quiz is 6.30/15.00.
            </h2>
            ...
            <div className="bg-gray-100 rounded-lg p-6 mb-6">
              ...
              <div className="grid grid-cols-2 gap-x-8 gap-y-3 text-sm">
                ...
                <div className="flex justify-between">
                  ...
                  <span className="text-gray-900">Monday, 22 September 2025, 8:09 AM</span>
                </div>
                <div></div>
                <div className="flex justify-between">
                  <span className="font-semibold text-gray-700">Completed</span>
                  <span className="text-gray-900">Monday, 22 September 2025, 8:34 AM</span>
                </div>
                <div></div>
                <div className="flex justify-between">
                ...
                <div className="flex justify-between">
                  ...
                  <span className="text-gray-900">10.50/25.00</span>
                </div>
                <div></div>
                <div className="flex justify-between">
                  <span className="font-semibold text-gray-700">Grade</span>
                  <span className="text-gray-900">6.30 out of 15.00 (42%)</span>
                </div>
              </div>
