...
export default function Quiz1COHDPage() {
  return (
      ...
      <div className="max-w-[1600px] mx-auto px-8 py-8">
        <div className="flex gap-8">
          ...
          <div className="flex-1">
            <h1 className="text-4xl font-bold text-gray-900 mb-8">Life Cycle</h1>
            ...
            <div className="space-y-3 mb-8 text-sm text-gray-700">
              ...
              <p>Time limit: 25 mins</p>
            </div>

            {/* Final Grade */}
            <h2 className="text-2xl font-bold text-gray-900 mb-8">
              Your final grade for this quiz is 8.80/15.00.
            </h2>
            ...
            <div className="bg-gray-100 rounded-lg p-6 mb-6">
              ...
              <div className="grid grid-cols-2 gap-x-8 gap-y-3 text-sm">
                ...
                <div className="flex justify-between">
                  ...
                  <span className="text-gray-900">Thursday, 25 September 2025, 8:05 AM</span>
                </div>
                <div></div>
                <div className="flex justify-between">
                  <span className="font-semibold text-gray-700">Completed</span>
                  <span className="text-gray-900">Thursday, 25 September 2025, 8:30 AM</span>
                </div>
                <div></div>
                <div className="flex justify-between">
                  <span className="font-semibold text-gray-700">Duration</span>
                  <span className="text-gray-900">24 mins 59 secs</span>
                </div>
                <div></div>
                <div className="flex justify-between">
                  <span className="font-semibold text-gray-700">Marks</span>
                  <span className="text-gray-900">14.67/25.00</span>
                </div>
                <div></div>
                <div className="flex justify-between">
                  <span className="font-semibold text-gray-700">Grade</span>
                  <span className="text-gray-900">8.80 out of 15.00 (59%)</span>
                </div>
              </div>
